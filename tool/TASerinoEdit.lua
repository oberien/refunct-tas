...
-- refunct-tas.exe TASerinoEdit.lua
-- frame({}, , , )
...
--[[teleportbutton(19)
setlocation(-1707.17, -4034.20, 339.27)
setrotation(-357.10, -1)
setvelocity(699.1, 35.42, 0)--]]
...
frame({forward, right}, 0, 0, 6)
frame({forward}, -12, 0, 6)
frame({forward}, 0, 0, 64)
frame({forward, jump}, 0, 0, 120)
