...
//        }
        ...
        unsafe extern "thiscall" fn #interceptor_name() -> ! {
            ...
            // call function_to_call
            llvm_asm!("call $0" :: "c"(#function_to_call as usize) :: "intel","volatile");
            // get consumed stack (negative value)
            llvm_asm!("sub ebx, esp" :::: "intel","volatile");

            // restore original function
            llvm_asm!("call $0" :: "c"(#unhook_function_name as usize) :: "intel","volatile");
            // restore stack
            llvm_asm!(r"
                add esp, 0x60
                add esp, ebx
            ...
            // hook method again
            llvm_asm!("call $0" :: "c"(#hook_function_name as usize) :: "intel","volatile");
