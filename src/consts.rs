...
#[cfg(windows)]
pub const FENGINELOOP_TICK_AFTER_UPDATETIME: usize = 0xe10000 + 0x4E8BCC;
// FApp::DeltaTime
// static variable inside the binary
#[cfg(unix)]
pub const APP_DELTATIME: usize = 0x57F0F40;
#[cfg(windows)]
pub const APP_DELTATIME: usize = 0xe10000 + 0x2239A68;
...
#[cfg(windows)]
pub const FSLATEAPPLICATION_TICK: usize = 0xe10000 + 0x730be0;
...
#[cfg(windows)]
pub const AMYCHARACTER_EXECFORCEDUNCROUCH: usize = 0xe10000 + 0x500840;
...
#[cfg(windows)]
pub const FSLATEAPPLICATION_ONKEYDOWN: usize = 0xe10000 + 0x721750;
...
#[cfg(windows)]
pub const FSLATEAPPLICATION_ONKEYUP: usize = 0xe10000 + 0x7218f0;
...
#[cfg(windows)]
pub const FSLATEAPPLICATION_ONRAWMOUSEMOVE: usize = 0xe10000 + 0x722610;
