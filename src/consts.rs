...
pub const AMYCHARACTER_EXECFORCEDUNCROUCH: &'static str = "_ZN12AMyCharacter18execForcedUnCrouchER6FFramePv";
...
pub const FSLATEAPPLICATION_ONRAWMOUSEMOVE: &'static str = "_ZN17FSlateApplication14OnRawMouseMoveEii";
